...
SCHEMA_EXPORTS: list[tuple[str, Any]] = [
    ...
    ("strategy-comparison-request.schema.json", strategy.StrategyComparisonRequest),
    ("strategy-comparison-response.schema.json", strategy.StrategyComparisonResponse),
    ("strategy-scenario-forecast-request.schema.json", strategy.StrategyScenarioForecastRequest),
    ("strategy-scenario-forecast-response.schema.json", strategy.StrategyScenarioForecastResponse),
    ("strategy-allocation-exposure-request.schema.json", strategy.StrategyAllocationExposureRequest),
    ("strategy-allocation-exposure-response.schema.json", strategy.StrategyAllocationExposureResponse),
    ("strategy-trade-history-request.schema.json", strategy.StrategyTradeHistoryRequest),
    ("strategy-trade-history-response.schema.json", strategy.StrategyTradeHistoryResponse),
...
TS_ALIAS_EXPORTS: list[tuple[str, Any]] = [
    ...
    ("StrategyAnalyticsSource", strategy.StrategyAnalyticsSource),
    ("StrategyComparisonRole", strategy.StrategyComparisonRole),
    ("StrategyMetricUnit", strategy.StrategyMetricUnit),
    ("StrategyForecastConfidence", strategy.StrategyForecastConfidence),
    ("StrategyForecastSampleMode", strategy.StrategyForecastSampleMode),
    ("StrategyTradeHistorySource", strategy.StrategyTradeHistorySource),
    ("StrategyTradeSide", strategy.StrategyTradeSide),
    ("StrategyAllocationExposureStatus", strategy.StrategyAllocationExposureStatus),
