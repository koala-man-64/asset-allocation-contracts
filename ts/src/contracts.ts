...
export type StrategyAnalyticsSource = 'control_plane' | 'backtest' | 'portfolio' | 'trade_desk' | 'broker';
...
export type StrategyForecastSampleMode = 'regime_conditioned' | 'fallback_history' | 'insufficient_history';
export type StrategyTradeHistorySource = 'backtest' | 'portfolio_ledger' | 'trade_order' | 'broker_fill';
